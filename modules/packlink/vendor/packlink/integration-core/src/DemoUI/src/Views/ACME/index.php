                    ...
                    templates: {
                        'pl-login-page': {
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/login')
                            ) ?>
                        },
                        'pl-register-page': {
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/register')
                            ) ?>
                        },
                        'pl-register-modal': <?php echo json_encode(
                            file_get_contents($baseResourcesPath . 'templates/register-modal')
                        ) ?>,
                        'pl-onboarding-welcome-page': {
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/onboarding-welcome')
                            ) ?>
                        },
                        'pl-onboarding-overview-page': {
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/onboarding-overview')
                            ) ?>
                        },
                        'pl-default-parcel-page': {
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/default-parcel')
                            ) ?>
                        },
                        'pl-default-warehouse-page': {
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/default-warehouse')
                            ) ?>
                        },
                        'pl-configuration-page': {
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/configuration')
                            ) ?>,
                            'pl-header-section': ''
                        },
                        'pl-order-status-mapping-page': {
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/order-status-mapping')
                            ) ?>,
                            'pl-header-section': ''
                        },
                        'pl-customs-page': {
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/customs')
                            )?>,
                            'pl-header-section': ''
                        },
                        'pl-system-info-modal': <?php echo json_encode(
                            file_get_contents($baseResourcesPath . 'templates/system-info-modal')
                        ) ?>,
                        'pl-my-shipping-services-page': {
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/my-shipping-services')
                            ) ?>,
                            'pl-header-section': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/shipping-services-header')
                            ) ?>,
                            'pl-shipping-services-table': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/shipping-services-table')
                            ) ?>,
                            'pl-shipping-services-list': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/shipping-services-list')
                            ) ?>
                        },
                        'pl-disable-carriers-modal': <?php echo json_encode(
                            file_get_contents($baseResourcesPath . 'templates/disable-carriers-modal')
                        ) ?>,
                        'pl-pick-service-page': {
                            'pl-header-section': '',
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/pick-shipping-services')
                            ) ?>,
                            'pl-shipping-services-table': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/shipping-services-table')
                            ) ?>,
                        ...
                        'pl-edit-service-page': {
                            'pl-header-section': '',
                            'pl-main-page-holder': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/edit-shipping-service')
                            ) ?>,
                            'pl-pricing-policies': <?php echo json_encode(
                                file_get_contents($baseResourcesPath . 'templates/pricing-policies-list')
                            ) ?>
                        },
                        'pl-pricing-policy-modal': <?php echo json_encode(
                            file_get_contents($baseResourcesPath . 'templates/pricing-policy-modal')
                        ) ?>,
                        'pl-countries-selection-modal': <?php echo json_encode(
                            file_get_contents($baseResourcesPath . 'templates/countries-selection-modal')
                        ) ?>,
                    }
                }
            );
