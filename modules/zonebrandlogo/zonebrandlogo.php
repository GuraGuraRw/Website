...
class ZOneBrandLogo extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Z.One - Brand Logo');
        $this->description = $this->l('Displays Manufacturers block with Brand Logo.');
        ...
        $fields_form = array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'switch',
                        'label' => $this->l('Only Show Manufacturers with Logos'),
                    ...
                    array(
                        'type' => 'switch',
                        'label' => $this->l('Only Show Manufacturers with Products'),
