...
class ZHomeBlock extends ObjectModel
{
    ...
    public static function getList($id_lang = null, $hook = false, $active = false, $active_mobile = false)
    {
    ...
    public static function getProductsByArrayId($array_product_id = null, $id_lang = null, $limit = 10)
    {
