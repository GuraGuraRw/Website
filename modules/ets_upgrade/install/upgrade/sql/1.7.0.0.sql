...
ALTER TABLE `PREFIX_tab` ADD `enabled` TINYINT(1) NOT NULL DEFAULT '1';
...
ALTER TABLE `PREFIX_tab` DROP COLUMN `enabled`;
ALTER TABLE `PREFIX_tab` DROP COLUMN `wording`;
ALTER TABLE `PREFIX_tab` DROP COLUMN `wording_domain`;
