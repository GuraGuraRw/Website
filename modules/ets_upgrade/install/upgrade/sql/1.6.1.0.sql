...
DROP TABLE IF EXISTS `ets_temp_table`;
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_cart_product`;
TRUNCATE TABLE `PREFIX_cart_product`;
ALTER TABLE `PREFIX_cart_product` ADD PRIMARY KEY (`id_cart`,`id_product`,`id_product_attribute`,`id_address_delivery`);
INSERT IGNORE INTO `PREFIX_cart_product` SELECT * from `ets_temp_table`;
DROP TABLE `ets_temp_table`;
...
DROP TABLE IF EXISTS `ets_temp_table`;
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_customization`;
TRUNCATE TABLE `PREFIX_customization`;
ALTER TABLE `PREFIX_customization` ADD KEY `id_cart_product` (`id_cart`, `id_product`, `id_product_attribute`);
INSERT IGNORE INTO `PREFIX_customization` SELECT * from `ets_temp_table`;
DROP TABLE `ets_temp_table`;
...
DROP TABLE IF EXISTS `ets_temp_table`;
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_image_shop`;
TRUNCATE TABLE `PREFIX_image_shop`;
ALTER TABLE `PREFIX_image_shop` DROP KEY `id_image`, ADD PRIMARY KEY (`id_image`, `id_shop`, `cover`);
INSERT IGNORE INTO `PREFIX_image_shop` SELECT * from `ets_temp_table`;
DROP TABLE `ets_temp_table`;
...
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_image_shop`;
TRUNCATE TABLE `PREFIX_image_shop`;
ALTER TABLE `PREFIX_image_shop` DROP PRIMARY KEY, ADD PRIMARY KEY (`id_image`, `id_shop`);
INSERT IGNORE INTO `PREFIX_image_shop` SELECT * from `ets_temp_table`;
DROP TABLE `ets_temp_table`;
...
DROP TABLE IF EXISTS `ets_temp_table`;
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_image`;
TRUNCATE TABLE `PREFIX_image`;
ALTER TABLE `PREFIX_image` ADD UNIQUE KEY `id_product_cover` (`id_product`,`cover`);
INSERT IGNORE INTO `PREFIX_image` SELECT * from `ets_temp_table`;
DROP TABLE `ets_temp_table`;
...
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_image_shop`;
TRUNCATE TABLE `PREFIX_image_shop`;
ALTER TABLE `PREFIX_image_shop` ADD UNIQUE KEY `id_product` (`id_product`, `id_shop`, `cover`);
INSERT IGNORE INTO `PREFIX_image_shop` SELECT * from `ets_temp_table`;
DROP TABLE `ets_temp_table`;
...
DROP TABLE IF EXISTS `ets_temp_table`;
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_product_attribute`;
TRUNCATE TABLE `PREFIX_product_attribute`;
ALTER TABLE `PREFIX_product_attribute` ADD UNIQUE KEY `product_default` (`id_product`,`default_on`);
INSERT IGNORE INTO `PREFIX_product_attribute` SELECT * from `ets_temp_table`;
DROP TABLE `ets_temp_table`;
...
DROP TABLE IF EXISTS `ets_temp_table`;
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_product_attribute_shop`;
TRUNCATE TABLE `PREFIX_product_attribute_shop`;
ALTER TABLE `PREFIX_product_attribute_shop` ADD UNIQUE KEY `id_product` (`id_product`, `id_shop`, `default_on`);
INSERT IGNORE INTO `PREFIX_product_attribute_shop` SELECT * from `ets_temp_table`;
DROP TABLE `ets_temp_table`;

DROP TABLE IF EXISTS `ets_temp_table`;
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_product_download`;
TRUNCATE TABLE `PREFIX_product_download`;
ALTER TABLE `PREFIX_product_download` ADD UNIQUE KEY `id_product` (`id_product`);
INSERT IGNORE INTO `PREFIX_product_download` SELECT * from `ets_temp_table`;
DROP TABLE `ets_temp_table`;
...
DROP TABLE IF EXISTS `ets_temp_table`;
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_specific_price`;
...
INSERT IGNORE INTO `PREFIX_specific_price` SELECT * from `ets_temp_table`;
DROP TABLE `ets_temp_table`;
