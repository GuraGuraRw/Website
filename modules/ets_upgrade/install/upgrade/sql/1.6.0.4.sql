...
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_meta`;
TRUNCATE TABLE `PREFIX_meta`;
ALTER TABLE `PREFIX_meta` ADD UNIQUE (`page`);
INSERT IGNORE INTO `PREFIX_meta` SELECT * from `ets_temp_table`;
