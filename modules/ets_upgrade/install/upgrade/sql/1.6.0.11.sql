...
CREATE TEMPORARY TABLE `ets_temp_table` SELECT * FROM `PREFIX_product`;
TRUNCATE TABLE `PREFIX_product`;
ALTER TABLE `PREFIX_product` CHANGE `ean13` `ean13` BIGINT( 15 ) NULL DEFAULT NULL;
INSERT IGNORE INTO `PREFIX_product` SELECT * from `ets_temp_table`;
...
ALTER TABLE `PREFIX_product_attribute` CHANGE `ean13` `ean13` BIGINT( 15 ) NULL DEFAULT NULL;;
