...
class UpgradeSelfCheck
{
	...
	*/
	 ...
	 * @var string
	*/
	private $configDir = '/modules/ets_upgrade/config.xml';
	...
	*/
    ...
    public function isIgnoreUpgrade()
    {
        return
            ($this->getMaxExecutionTime() == 0 || $this->getMaxExecutionTime() >= 120)
            && $this->isSafeModeDisabled();
	}
	...
	*/
	private function checkSafeModeIsDisabled()
	{
		...
		return !in_array(Tools14::strtolower($safeMode), array(1, 'on'));
	}
	...
	*/
	public function runPrestaShopCoreChecks()
	{
        ...
        foreach ($folders as $folder) {
            $folder = rtrim(_PS_ROOT_DIR_, '\\/').DIRECTORY_SEPARATOR.trim($folder, '\\/');
