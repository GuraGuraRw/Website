...
{if $displayedFacets|count}
  <div id="search_filters">
    {block name='facets_title'}
      <p class="column-title d-none d-md-block">{l s='Filter By' d='Shop.Theme.Actions'}</p>
    {/block}
    ...
    {foreach from=$displayedFacets item="facet"}
      <section class="facet clearfix">
        <p class="h5 facet-title d-none d-md-block"><i class="fa fa-angle-double-right" aria-hidden="true"></i>{$facet.label}</p>
        ...
        <div class="facet-title d-flex d-md-none" data-bs-target="#facet_{$_expand_id}" data-bs-toggle="collapse"{if !$_collapse} aria-expanded="true"{/if}>
          <span><i class="fa fa-angle-double-right" aria-hidden="true"></i>{$facet.label}</span>
          ...
          {block name='facet_item_other'}
            <ul id="facet_{$_expand_id}" class="faceted-{$facet.widgetType} collapse{if !$_collapse} show{/if}">
              {foreach from=$facet.filters key=filter_key item="filter"}
                ...
                <li>
                  <div class="facet-label {if $filter.active}active{/if}">
