  ...
  <div id="search_filters" class="js-search-filters">
    ...
    {foreach from=$facets item="facet"}
      ...
      <section class="facet">
        ...
        {/foreach}
        <div class="title d-block d-md-none" data-bs-target="#facet_{$_expand_id}" data-bs-toggle="collapse"{if !$_collapse} aria-expanded="true"{/if}>
            ...
            <ul id="facet_{$_expand_id}" class="collapse{if !$_collapse} in{/if}">
              <li>
                <div class="facet-dropdown dropdown">
                  <div class="dropdown-toggle select-title expand-more" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    {$active_found = false}
                    <span>
                      {foreach from=$facet.filters item="filter"}
                        {if $filter.active}
