...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('cnv6j5Hbfr', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NHcr5Pm7ix', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'xbxgxbqgura1.mysql.db', 'port' => '3306', 'dbname' => 'xbxgxbqgura1', 'user' => 'xbxgxbqgura1', 'password' => 'M3vR8kL5qZ1pT6dW9yXn', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $g = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => ($this->targetDirs[3].'/modules/doofinder/src/Entity')]);
        $g->addExcludePaths([0 => ($this->targetDirs[3].'/modules/doofinder/src/Entity/index.php')]);
        ...
        $b->addDriver($g, 'PrestaShop\\Module\\Doofinder\\Src\\Entity');
        ...
        $a->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('pre9068_'))) && false ?: '_'});
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('pre9068_');
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('d4F4vw5oqI', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NE9PUHKdzg', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bgbzjp-x2b', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0TyapqTp0AncpcSyyIOYb6m0woTx6XyvVqBNgezDCH1cowPZasccXkKawmfvqwU8'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0TyapqTp0AncpcSyyIOYb6m0woTx6XyvVqBNgezDCH1cowPZasccXkKawmfvqwU8');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                56 => ($this->targetDirs[3].'/modules/zonebrandlogo/translations'),
                57 => ($this->targetDirs[3].'/modules/zonecolorsfonts/translations'),
                58 => ($this->targetDirs[3].'/modules/zonecolumnblocks/translations'),
                59 => ($this->targetDirs[3].'/modules/zonefeaturedcategories/translations'),
                60 => ($this->targetDirs[3].'/modules/zonehomeblocks/translations'),
                61 => ($this->targetDirs[3].'/modules/zonemegamenu/translations'),
                62 => ($this->targetDirs[3].'/modules/zonepopupnewsletter/translations'),
                63 => ($this->targetDirs[3].'/modules/zoneproductadditional/translations'),
                64 => ($this->targetDirs[3].'/modules/zoneslideshow/translations'),
                65 => ($this->targetDirs[3].'/modules/zonethememanager/translations'),
                66 => ($this->targetDirs[3].'/modules/creativeelements/translations'),
                67 => ($this->targetDirs[3].'/modules/ps_bestsellers/translations'),
                68 => ($this->targetDirs[3].'/modules/ps_newproducts/translations'),
                69 => ($this->targetDirs[3].'/modules/ps_specials/translations'),
                70 => ($this->targetDirs[3].'/modules/statsbestmanufacturers/translations'),
                71 => ($this->targetDirs[3].'/modules/ps_categoryproducts/translations'),
                72 => ($this->targetDirs[3].'/modules/ps_viewedproduct/translations'),
                73 => ($this->targetDirs[3].'/modules/autoupgrade/translations'),
                74 => ($this->targetDirs[3].'/modules/ets_onepagecheckout/translations'),
                75 => ($this->targetDirs[3].'/modules/doofinder/translations'),
                76 => ($this->targetDirs[3].'/modules/sendinblue/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                65 => 'zonecolorsfonts',
                66 => 'zonecolumnblocks',
                67 => 'zonefeaturedcategories',
                68 => 'zonehomeblocks',
                69 => 'zonemegamenu',
                70 => 'zonepopupnewsletter',
                71 => 'zoneproductadditional',
                72 => 'zoneslideshow',
                73 => 'zonethememanager',
                74 => 'creativeelements',
                75 => 'ps_bestsellers',
                76 => 'ps_newproducts',
                77 => 'ps_specials',
                78 => 'statsbestmanufacturers',
                79 => 'ps_categoryproducts',
                80 => 'ps_viewedproduct',
                81 => 'autoupgrade',
                82 => 'ets_onepagecheckout',
                83 => 'doofinder',
                84 => 'sendinblue',
            ],
            ...
            'kernel.secret' => '0TyapqTp0AncpcSyyIOYb6m0woTx6XyvVqBNgezDCH1cowPZasccXkKawmfvqwU8',
