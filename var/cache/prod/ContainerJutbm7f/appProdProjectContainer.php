...
class appProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'crisp.context' => 'getCrisp_ContextService.php',
            'crisp.module' => 'getCrisp_ModuleService.php',
            'crisp.ps_accounts_facade' => 'getCrisp_PsAccountsFacadeService.php',
            'crisp.ps_accounts_installer' => 'getCrisp_PsAccountsInstallerService.php',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zyDhMfwpXE', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_4b581c6994e6783efd55733feff83816fe09934fa4295faa2e75e204ebb6ff25');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                77 => ($this->targetDirs[3].'/modules/tiktokforbusiness/translations'),
                78 => ($this->targetDirs[3].'/modules/crisp/translations'),
                79 => ($this->targetDirs[3].'/modules/packlink/translations'),
            ]; break;
